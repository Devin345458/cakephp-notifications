 ...
 */
class MorphsMany extends Association
{
    /**
    ...
    public function saveAssociated(EntityInterface $entity, array $options = [])
    {
        ...
        $foreignKeyReference = [
            ...
            $this->getTypeKey() => get_class($this->getSource())
        ];
    ...
    {
        [, $name] = pluginSplit($this->getTarget()->getTable());
        return Inflector::underscore(Inflector::singularize($name)) . 'able';
    }
